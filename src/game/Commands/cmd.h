...
extern void SendNotice(const char * c_pszBuf);		// АМ °ФАУј­№цїЎёё °шБц
extern void SendLog(const char * c_pszBuf);		// їоїµАЪїЎ°Фёё °шБц
extern void BroadcastNotice(const char * c_pszBuf);	// Аь ј­№цїЎ °шБц
extern void SendNoticeMap(const char* c_pszBuf, int nMapIndex, bool bBigFont); // БцБ¤ ёКїЎёё °шБц
extern void SendMonarchNotice(BYTE bEmpire, const char * c_pszBuf);		// °°Ає Б¦±№їЎ°Ф °шБц
