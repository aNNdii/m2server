...
class P2P_MANAGER : public singleton<P2P_MANAGER>
{
	public:
		...
		// ѕЖ·Ў Register* Unregister* pairµйАє і»єОАыАё·О »зЅЗ °°Ає ·зЖѕА» »зїлЗСґЩ.
		// ґЬБц ёнЅГАыАё·О ЗҐЅГЗП±в А§ЗС °Н
		...
		void			EraseUserByDesc(LPDESC d);	// ЗШґз descїЎ АЦґВ АЇАъµйА» БцїоґЩ.

		void			FlushOutput();

		void			Boot(LPDESC d);	// p2p Гіё®їЎ ЗКїдЗС Б¤єёё¦ єёі»БШґЩ. (Аь ДіёЇЕНАЗ ·О±ЧАО Б¤єё µо)
