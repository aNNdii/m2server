...
class CFuncViewInsert
{
	...
	public:
		...
		{
			// їАєкБ§Ж®°Ў ѕЖґС °НАє °Её®ё¦ °и»кЗПї© °Её®°Ў ёЦёй ГЯ°ЎЗПБц ѕКґВґЩ.
			...
			if (ent->IsType(ENTITY_CHARACTER) && m_me->IsType(ENTITY_CHARACTER))
			{
				...
				// ґл»уАМ NPCёй StateMachineА» ЕІґЩ.
...
void CEntity::UpdateSectree()
{
	...
	CFuncViewInsert f(this); // іЄё¦ јЅЖ®ё®їЎ АЦґВ »з¶чµйїЎ°Ф ГЯ°Ў
	GetSectree()->ForEachAround(f);

	ENTITY_MAP::iterator it, this_it;

	//
	// m_map_viewїЎј­ ЗКїд ѕшґВ іај®µй Бцїм±в
	// 
