...
class DBManager : public singleton<DBManager>
{
	public:
		...
		template<class Functor> void FuncQuery(Functor f, const char * c_pszFormat, ...); // °б°ъё¦ fАОАЪ·О ИЈГвЗФ (SQLMsg *) ѕЛѕЖј­ ЗШБ¦µК
		template<class Functor> void FuncAfterQuery(Functor f, const char * c_pszFormat, ...); // іЎіЄ°н іЄёй f°Ў ИЈГвµК void			f(void) ЗьЕВ
