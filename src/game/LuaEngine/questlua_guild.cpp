...
namespace quest
{
	...
	{
		// ё®ЕП°Є
		//	0 : АФ·ВЗС АМё§АМ АЯёшµЗѕъАЅ ( №®АЪї­АМ ѕЖґФ )
		//	1 : ±жµеАеАМ ѕЖґФ
		//	2 : БцБ¤ЗС АМё§АЗ ±жµеїшАМ ѕшАЅ
		//	3 : їдГ» јє°ш
		//	4 : ±жµе°Ў ѕшАЅ
	...
	int guild_change_master_with_limit(lua_State* L)
	{
		...
		//  arg0 : »х ±жµеАе АМё§
		//  arg1 : »х ±жµеАе ·№є§ Б¦ЗС
		//  arg2 : resign_limit Б¦ЗС ЅГ°Ј
		//  arg3 : be_other_leader Б¦ЗС ЅГ°Ј
		//  arg4 : be_other_member Б¦ЗС ЅГ°Ј
		//  arg5 : ДіЅГЕЫАО°Ў ѕЖґС°Ў
		//
		// ё®ЕП°Є
		//	0 : АФ·ВЗС АМё§АМ АЯёшµЗѕъАЅ ( №®АЪї­АМ ѕЖґФ )
		//	1 : ±жµеАеАМ ѕЖґФ
		...
		//	3 : їдГ» јє°ш
		//	4 : ±жµе°Ў ѕшАЅ
		//	5 : БцБ¤ЗС АМё§АМ їВ¶уАОАМ ѕЖґФ
		//	6 : БцБ¤ЗС ДіёЇЕН ·№є§АМ ±вБШ·№є§єёґЩ і·АЅ
		//	7 : »х ±жµеАеАМ be_other_leader Б¦ЗСїЎ °ЙёІ
