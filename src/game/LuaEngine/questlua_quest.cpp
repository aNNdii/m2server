...
namespace quest
{
	...
	{
		CQuestManager& q = CQuestManager::instance();
		// other_pc_block і»єОїЎј­ґВ yield°Ў АПѕоіЄј­ґВ ѕИµИґЩ. Аэґл·О.
	...
	void RegisterQuestFunctionTable()
	{
		luaL_reg quest_functions[] = 
		{
			...
			// begin_other_pc_block(pid), end_other_pc_block »зАМё¦ other_pc_blockАМ¶у°н ЗПАЪ.
			// other_pc_blockїЎј­ґВ current_pc°Ў pid·О єЇ°жµИґЩ.
			//						іЎіЄёй ґЩЅГ їш·ЎАЗ current_pc·О µ№ѕЖ°ЈґЩ.
			/*		АМ·± °НА» А§ЗШ ёёµл.
			...
			*/
			// БЦАЗ : other_pc_block і»єОїЎј­ґВ Аэґл·О yield°Ў АПѕоіЄј­ґВ ѕИµИґЩ.(ex. wait, select, input, ...)
