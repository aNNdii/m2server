...
namespace quest
{
	...
	int highscore_register(lua_State* L)
	{
		...
		enhance_strlcpymt(qi->szBoard, lua_tostring(L, 1), sizeof(qi->szBoard));
	...
	/**
	 * @version 05/06/08	Bang2ni - __get_guildid_byname ЅєЕ©ёіЖ® ЗФјц µо·П
	 */
	...
	void CQuestManager::GotoConfirmState(QuestState & qs)
	{
		...
		// 1. »уґл№жїЎ°Ф И®АОГў ¶зїт
		// 2. іЄїЎ°Ф И®АО ±вґЩё°ґЩ°н ЗҐЅГЗПґВ Гў ¶зїт
		// 3. ЕёАУѕЖїф јіБ¤ (ЕёАУѕЖїф µЗёй »уґл№ж Гў ґЭ°н іЄїЎ°Фµµ Гў ґЭАё¶у°н єёії)

		// 1
		// »уґл№жАМ ѕшґВ °жїмґВ ±ЧіЙ »уґл№жїЎ°Ф єёі»Бц ѕКґВґЩ. ЕёАУѕЖїфїЎ АЗЗШј­ іСѕо°Ў°ФµК
