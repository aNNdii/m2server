...
class CDungeon
{
	...
	int	CountMonster() { return m_iMonsterCount; }	// µҐАМЕН·О ё®БЁЗС ёуЅєЕНАЗ јц
	int	CountRealMonster();				// ЅЗБ¦·О ёК»уїЎ АЦґВ ёуЅєЕН
	...
	// item groupАє item_vnum°ъ item_count·О ±ёјє.
	...
	// ЖДЖј ґЬА§ ґшАь АФАеА» А§ЗС АУЅГ єЇјц.
	// m_map_pkPartyґВ °ьё®°Ў єОЅЗЗПї© »зїлЗТ јц ѕшґЩ°н ЖЗґЬЗПї©,
	// АУЅГ·О ЗС ЖДЖјїЎ ґлЗС °ьё®ё¦ ЗПґВ єЇјц »эјє.
