...
class SECTREE_MANAGER : public singleton<SECTREE_MANAGER>
{
	public:
		...
		/// їµїЄїЎ ґлЗШ Sectree АЗ Attribute їЎ ґлЗШ ЖЇБ¤ЗС Гіё®ё¦ јцЗаЗСґЩ.
		/**
		 * @param [in]	lMapIndex АыїлЗТ Map index
		 * @param [in]	lStartX »з°ўЗь їµїЄАЗ °ЎАе їЮВК БВЗҐ
		 * @param [in]	lStartY »з°ўЗь їµїЄАЗ °ЎАе А§ВК БВЗҐ
		 * @param [in]	lEndX »з°ўЗь їµїЄАЗ °ЎАе їАёҐВК БВЗҐ
		 * @param [in]	lEndY »з°ўЗь їµїЄАЗ °ЎАе ѕЖ·§ВК БВЗҐ
		 * @param [in]	lRotate їµїЄїЎ ґлЗШ ИёАьЗТ °ў
		 * @param [in]	dwAttr АыїлЗТ Attribute
		 * @param [in]	mode Attribute їЎ ґлЗШ Гіё®ЗТ type
		 */
	...
	private:
		...
		/// Бч°ўАЗ »з°ўЗь їµїЄїЎ ґлЗШ Sectree АЗ Attribute їЎ ґлЗШ ЖЇБ¤ЗС Гіё®ё¦ јцЗаЗСґЩ.
		/**
		 * @param [in]	lMapIndex АыїлЗТ Map index
		 * @param [in]	lCX »з°ўЗь їµїЄАЗ °ЎАе їЮВК Cell АЗ БВЗҐ
		 * @param [in]	lCY »з°ўЗь їµїЄАЗ °ЎАе А§ВК Cell АЗ БВЗҐ
		 * @param [in]	lCW »з°ўЗь їµїЄАЗ Cell ґЬА§ Жш
		 * @param [in]	lCH »з°ўЗь їµїЄАЗ Cell ґЬА§ іфАМ
		 * @param [in]	lRotate ИёАьЗТ °ў(Бч°ў)
		 * @param [in]	dwAttr АыїлЗТ Attribute
		 * @param [in]	mode Attribute їЎ ґлЗШ Гіё®ЗТ type
		 */
		...
		/// Бч°ў АМїЬАЗ »з°ўЗь їµїЄїЎ ґлЗШ Sectree АЗ Attribute їЎ ґлЗШ ЖЇБ¤ЗС Гіё®ё¦ јцЗаЗСґЩ.
		/**
		 * @param [in]	lMapIndex АыїлЗТ Map index
		 * @param [in]	lCX »з°ўЗь їµїЄАЗ °ЎАе їЮВК Cell АЗ БВЗҐ
		 * @param [in]	lCY »з°ўЗь їµїЄАЗ °ЎАе А§ВК Cell АЗ БВЗҐ
		 * @param [in]	lCW »з°ўЗь їµїЄАЗ Cell ґЬА§ Жш
		 * @param [in]	lCH »з°ўЗь їµїЄАЗ Cell ґЬА§ іфАМ
		 * @param [in]	lRotate ИёАьЗТ °ў(Бч°ў АМїЬАЗ °ў)
		 * @param [in]	dwAttr АыїлЗТ Attribute
		 * @param [in]	mode Attribute їЎ ґлЗШ Гіё®ЗТ type
		 */
		...
		/// ЗС Cell АЗ Attribute їЎ ґлЗШ ЖЇБ¤ЗС Гіё®ё¦ јцЗаЗСґЩ.
		/**
		 * @param [in]	lMapIndex АыїлЗТ Map index
		 * @param [in]	lCX АыїлЗТ Cell АЗ X БВЗҐ
		 * @param [in]	lCY АыїлЗТ Cell АЗ Y БВЗҐ
		 * @param [in]	dwAttr АыїлЗТ Attribute
		 * @param [in]	mode Attribute їЎ ґлЗШ Гіё®ЗТ type
		 */
