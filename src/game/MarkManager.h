...
class CGuildMarkManager : public singleton<CGuildMarkManager>
{
	public:
		...
		bool LoadMarkIndex(); // ё¶Е© АОµ¦Ѕє єТ·ЇїА±в (ј­№цїЎј­ёё »зїл)
		bool SaveMarkIndex(); // ё¶Е© АОµ¦Ѕє АъАеЗП±в

		void LoadMarkImages(); // ёрµз ё¶Е© АМ№МБцё¦ єТ·ЇїА±в
		void SaveMarkImage(DWORD imgIdx); // ё¶Е© АМ№МБц АъАе
