...
enum
{
	...
	ITEM_SKILLFORGET2_VNUM = 70055,		// 7, 8 ЅєЕі ёБ°ўј­

	UNIQUE_ITEM_FISH_MIND = 71008,		// їщ°ЈѕоЅЙ
	UNIQUE_ITEM_SAFEBOX_EXPAND = 71009,		// Гў°нИ®Ае±З
	UNIQUE_ITEM_AUTOLOOT_GOLD = 71010,		// Б¦3АЗ јХ
	UNIQUE_ITEM_EMOTION_MASK = 71011,	// ї­Б¤АЗ °Ўёй
	UNIQUE_ITEM_EMOTION_MASK2 = 71033,	// ї­Б¤АЗ °Ўёй
	...
	// їлИҐј® ГЯГв И®·ьА» іфї©БЦґВ ѕЖАМЕЫ
	DRAGON_SOUL_EXTRACTOR_GROUP = 10600,
	// їлЅЙ ГЯГвЗШБЦґВ ѕЖАМЕЫ
	DRAGON_HEART_EXTRACTOR_GROUP = 10601,
	// їлИҐј®їЎј­ ГЯГвЗТ ¶§ БЦґВ їлЅЙ.
