...
class SECTREE
{
	...
	public:
		...
		void				CloneAttribute(LPSECTREE tree); // private map Гіё®ЅГ »зїл

		int				GetEventAttribute(long x, long y); // 20050313 ЗцАзґВ »зїлЗПБц ѕКАЅ
