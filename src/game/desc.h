...
class DESC
{
	...
	public:
		...
		void			SetAdminMode();
		bool			IsAdminMode();		// Handshake їЎј­ ѕоµе№О ён·ЙА» ѕµјцАЦіЄ?
	...
	protected:
		...
		bool			m_bAdminMode; // Handshake їЎј­ ѕоµе№О ён·ЙА» ѕµјцАЦіЄ?
		bool			m_bPong;
