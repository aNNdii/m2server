...
public:
	...
	template <typename T>
	bool GetValue(size_t i, const std::string & c_rstrColKey, T& tValue) const;	// n№шВ°(mapїЎ µйѕоАЦґВ јшј­АП »У, txtАЗ јшј­їНґВ °ь°и ѕшАЅ) rowАЗ ЖЇБ¤ ДГ·іАЗ °ЄА» №ЭИЇЗПґВ ЗФјц. 
																				// АМБъАыАМ±д ЗПБцёё, ЖнАЗё¦ А§ЗС ЗФјц.
	template <typename T>
	...
	// Вь°н·О, idx¶ы txtїЎ ѕІї©Бш јшј­¶ы °ь°и ѕшАЅ.
