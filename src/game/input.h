...
protected:
	...
	void		PlayerCreateFailure(LPDESC d, BYTE bType);	// 0 = АП№Э ЅЗЖР 1 = АМ№М АЦАЅ
	...
	// MYSHOP_PRICE_LIST
	/// ѕЖАМЕЫ °Ў°ЭБ¤єё ё®ЅєЖ® їдГ»їЎ ґлЗС ААґд ЖРЕ¶(HEADER_DG_MYSHOP_PRICELIST_RES) Гіё®ЗФјц
	/**
	* @param	d ѕЖАМЕЫ °Ў°ЭБ¤єё ё®ЅєЖ®ё¦ їдГ»ЗС ЗГ·№АМѕоАЗ descriptor
	* @param	p ЖРЕ¶µҐАМЕНАЗ ЖчАОЕН
	*/
