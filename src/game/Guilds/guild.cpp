...
CGuild::CGuild(TGuildCreateParameter & cp)
{
	...
	enhance_strlcpymt(m_data.grade_array[0].grade_name, LC_TEXT("길드장"), sizeof(m_data.grade_array[0].grade_name));
	...
	{
		enhance_strlcpymt(m_data.grade_array[i].grade_name, LC_TEXT("길드원"), sizeof(m_data.grade_array[i].grade_name));
