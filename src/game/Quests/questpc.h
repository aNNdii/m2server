	...
	class PC
	{
		public:
			enum 
			{
				...
				QUEST_SEND_TITLE		= (1 << 1),  // 30АЪ ±оБц 
				QUEST_SEND_CLOCK_NAME		= (1 << 2),  // 16АЪ ±оБц		
				QUEST_SEND_CLOCK_VALUE		= (1 << 3),
				QUEST_SEND_COUNTER_NAME		= (1 << 4),  // 16АЪ ±оБц	
				QUEST_SEND_COUNTER_VALUE	= (1 << 5),
				QUEST_SEND_ICON_FILE		= (1 << 6),  // 24АЪ ±оБц
			};
		...
		private:
			...
			int			m_iSendToClient;
			bool		m_bLoaded; // ·ОµеґВ ЗС№шёё ЗСґЩ.
