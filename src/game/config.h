...
extern bool	g_bTrafficProfileOn;		///< true АМёй TrafficProfiler ё¦ ДТґЩ.
...
extern bool g_protectNormalPlayer;      // №ь№эАЪ°Ў "ЖтИ­ёрµе" АО АП№ЭАЇАъё¦ °ш°ЭЗПБц ёшЗФ
extern bool g_noticeBattleZone;         // БЯёіБцґлїЎ АФАеЗПёй ѕИі»ёЮјјБцё¦ ѕЛ·ББЬ
