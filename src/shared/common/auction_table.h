...
public:
	...
	// АМ ёЮјТµеµйАє ѕо¶І єЇјц°Ў auctionїЎј­ ѕо¶І їЄЗТА» ЗПґВБц ±оёФА» ±оєБ
	// ёёµйѕоіхѕТґЩ.
	// by rtsummit
...
// №ЭµеЅГ FAIL ѕХїЎ, ЅЗЖР ·щ µйАМ їНѕЯЗСґЩ.
// їЦіД, <= AUCTION_FAIL АМ·± CHECKА» ЗТ °Е°Еµз
// №Эґл·О SUCCESS µЪїЎ, јє°ш ·щ µйАМ їНѕЯЗСґЩ. ±ЩµҐ јє°ш·щ°Ў АЦ±д ЗП·БіЄ...
...
//	start_idx;
//	size;
//	conditions; Б¤·ДАє ЅВГ¶ґФІІ Б¶ѕрА» ±ёЗШєёАЪ.¤·¤·
//}
//
