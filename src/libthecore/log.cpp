/*
 *    Filename: log.c
 * Description: local log file °ь·Г
 *
...
#ifndef _WIN32
	// log_levelАМ 1 АМ»уАП °жїмїЎґВ ЕЧЅєЖ®АП °жїм°Ў ё№АёґП stdoutїЎµµ Гв·ВЗСґЩ.
	if (log_level_bits > 1)
	{
#endif
