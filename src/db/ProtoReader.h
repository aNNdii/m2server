...
//csv ЖДАПА» АРѕоїНј­ ѕЖАМЕЫ ЕЧАМєнїЎ іЦѕоБШґЩ.
void putItemIntoTable(); //(ЕЧАМєн, ЕЧЅєЖ®ї©єО)
...
bool Set_Proto_Npc_Table(TMobTable *mobTable, cCsvTable &csvTable, std::map<int, const char*> &nameMap);
