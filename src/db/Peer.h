...
#pragma pack()
	...
	DWORD	m_dwHandle;
	DWORD	m_dwUserCount;
	WORD	m_wListenPort;	// °ФАУј­№ц°Ў Е¬¶уАМѕрЖ®ё¦ А§ЗШ listen ЗПґВ ЖчЖ®
	WORD	m_wP2PPort;	// °ФАУј­№ц°Ў °ФАУј­№ц P2P БўјУА» А§ЗШ listen ЗПґВ ЖчЖ®
	long	m_alMaps[32];	// ѕо¶І ёКА» °ьАеЗП°н АЦґВ°Ў?
