...
//g_iLogoutSeconds јцДЎґВ g_iPlayerCacheFlushSeconds їН g_iItemCacheFlushSeconds єёґЩ ±жѕоѕЯ ЗСґЩ.
...
{
	if (!(pulse % heart->passes_per_sec))	// 1ГКїЎ ЗС№ш
	{
	}
}

//
// @version	05/06/13 Bang2ni - ѕЖАМЕЫ °Ў°ЭБ¤єё ДіЅГ flush timeout јіБ¤ ГЯ°Ў.
//
int Start()
{
