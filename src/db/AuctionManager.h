...
{
private:
	// auctionїЎ µо·ПµИ ѕЖАМЕЫµй.
	typedef boost::unordered_map<DWORD, CItemCache *> TItemCacheMap;
	TItemCacheMap auction_item_cache_map;

	// auctionїЎ µо·ПµИ Б¤єё БЯ °Ў°Э, µоµо ѕЖАМЕЫ ЕЧАМєнїЎ ЖчЗФµЗБц ѕКґВ Б¤єёµйА» °ьё®ЗПґВ °Нµй
